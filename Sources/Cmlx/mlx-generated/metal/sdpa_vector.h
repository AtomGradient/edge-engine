...
constant bool output_scores [[function_constant(27)]];
...
[[kernel]] void sdpa_vector(
    ...
    device float* scores_out [[buffer(18), function_constant(output_scores)]],
  ...
  for (int i = simd_gid; i < N; i += BN) {
    ...
    if (use_key) {
      ...
      // Output pre-softmax score for DSR attention
...
[[kernel]] void sdpa_vector_2pass_1(
    ...
    device float* scores_out [[buffer(19), function_constant(output_scores)]],
